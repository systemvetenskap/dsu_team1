    ...
    <div class="fullBox">
        <div class="halfBox em-margin-horizontal">
            <p class="em-margin-horizontal">Förnamn: 
                <asp:RequiredFieldValidator ID="validatorFirstName" ControlToValidate="txtFistName" ForeColor="Red" runat="server" Font-Size="Smaller" ErrorMessage="Fyll i ett namn"></asp:RequiredFieldValidator></p>
            <asp:TextBox ID="txtFistName" CssClass="my-txt-box" runat="server"></asp:TextBox>
            <p class="em-margin-horizontal">Efternamn: 
                <asp:RequiredFieldValidator ID="validatorLastName" ControlToValidate="txtLastName"  ForeColor="Red" runat="server" Font-Size="Smaller"  ErrorMessage="Fyll i ett efternamn"></asp:RequiredFieldValidator></p>
            <asp:TextBox ID="txtLastName" CssClass="my-txt-box" runat="server"></asp:TextBox>
            <p class="em-margin-horizontal">Kön: 
                <asp:RequiredFieldValidator ID="validatorKon" ControlToValidate="dropDownListKon" InitialValue="Välj" ForeColor="Red" Font-Size="Smaller"  runat="server" ErrorMessage="Välj kön"></asp:RequiredFieldValidator></p>
            ...
            <p class="em-margin-horizontal">Telefonnummer: 
                <asp:RequiredFieldValidator ID="validatorPhone" ControlToValidate="txtPhone" ForeColor="Red" runat="server" Font-Size="Smaller"  ErrorMessage="Fyll i ett telefonnummer"></asp:RequiredFieldValidator></p>
            <asp:TextBox ID="txtPhone" CssClass="my-txt-box" runat="server"></asp:TextBox>
            <p class="em-margin-horizontal">Epost: 
                <asp:RequiredFieldValidator ID="validatorEmail" ControlToValidate="txtEmail" ForeColor="Red" runat="server" Font-Size="Smaller"  ErrorMessage="Ange en epost."></asp:RequiredFieldValidator>
                <asp:RegularExpressionValidator ID="regExValidatorEmail" ForeColor="Red" Font-Size="Smaller" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ControlToValidate="txtEmail" runat="server" ErrorMessage="Felaktigt epost format"></asp:RegularExpressionValidator>
            </p>
        ...
        <div class="halfBox em-margin-horizontal">
            <p class="em-margin-horizontal">Adress: 
                <asp:RequiredFieldValidator ID="validatorAddess" ControlToValidate="txtAddress" ForeColor="Red" runat="server" Font-Size="Smaller"  ErrorMessage="Fyll i en adress"></asp:RequiredFieldValidator></p>
            <asp:TextBox ID="txtAddress" CssClass="my-txt-box" runat="server"></asp:TextBox>
            <p class="em-margin-horizontal">Postnummer: 
                <asp:RequiredFieldValidator ID="validatorPostalCode" ControlToValidate="txtPostalCode" ForeColor="Red" runat="server" Font-Size="Smaller"  ErrorMessage="Fyll i ett postnummer"></asp:RequiredFieldValidator></p>
            <asp:TextBox ID="txtPostalCode" CssClass="my-txt-box" runat="server"></asp:TextBox>
            <p class="em-margin-horizontal">Ort: 
                <asp:RequiredFieldValidator ID="validatorCity" ControlToValidate="txtCity" ForeColor="Red" runat="server" Font-Size="Smaller"  ErrorMessage="Fyll i en ort"></asp:RequiredFieldValidator></p>
            <asp:TextBox ID="txtCity" CssClass="my-txt-box" runat="server"></asp:TextBox>
            <p class="em-margin-horizontal">Handikapp: 
                <asp:RequiredFieldValidator ID="validatprHcp" ControlToValidate="txtHcp" ForeColor="Red" runat="server" Font-Size="Smaller"  ErrorMessage="Fyll i ett handikapp"></asp:RequiredFieldValidator>
                <asp:RangeValidator ID="rangeValidatorHcp" ControlToValidate="txtHcp" Type="Double" MaximumValue="99,99" Font-Size="Smaller"  ForeColor="Red" MinimumValue="0" runat="server" ErrorMessage="Endast siffror och kommatecken."></asp:RangeValidator>
            </p>
                
            <asp:TextBox ID="txtHcp" CssClass="my-txt-box" runat="server"></asp:TextBox>
            <p class="em-margin-horizontal">Medlemstyp: 
                <asp:RequiredFieldValidator ID="validatorMembertype" ControlToValidate="dropDownMemberType" InitialValue="Välj" Font-Size="Smaller"  ForeColor="Red" runat="server" ErrorMessage="Välj medlemstyp"></asp:RequiredFieldValidator></p>
            ...
            <p class="em-margin-horizontal">Medlemsavgift betald: 
                <asp:RequiredFieldValidator ID="validatorPayStatus" ControlToValidate="dropDownPayStatus" InitialValue="Välj" Font-Size="Smaller"  ForeColor="Red" runat="server" ErrorMessage="Du måste välja ja eller nej."></asp:RequiredFieldValidator></p>
